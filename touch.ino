...
void touchInit()
{
  ROM_GPIOPinTypeGPIOOutput(CS_PORT,CS_PIN);
  ROM_GPIOPinTypeGPIOInput(IRQ_PORT,IRQ_PIN);
  ROM_GPIOPadConfigSet(IRQ_PORT, IRQ_PIN, GPIO_STRENGTH_2MA, GPIO_PIN_TYPE_STD_WPU);
  ROM_GPIOPinTypeGPIOInput(MISO_PORT,MISO_PIN);
  ROM_GPIOPinTypeGPIOOutput(MOSI_PORT,MOSI_PIN);
  ROM_GPIOPinTypeGPIOOutput(CLK_PORT,CLK_PIN);
  CS_HIGH;
